onload = function () {
    ...
    text = '2D array as input is given. Each column stores rewards on higher and lower platform. ' +
        'Return an array stating 1 if you want to jump to higher platform, otherwise 0. Also, ' +
        'after selecting 1 you have to select 0 the next time.\n';
